   ...
   <div class="box">
    ...
    <div class="center">
        ...
        <c:forEach items="${clist }" var="cart">
          <tr> <td>商品名称</td> <td>单价</td> <td>数量</td><td>小计</td><td>操作</td></tr>
     
          <tr>
             <td>
                ${cart.iphones. iname}</td>
             <td>${cart.iphones.iprice }</td>
             <td>${cart.quantity }</td>
              <td>${cart.iphones.iprice*cart.quantity  }</td>
             <td>
                <a href="#">删除</a>
                <a href="#">修改</a>
             </td>
